<?php
    ...
    class Mensagem{
        ...
        //validar se os atributos estão preenchidos
    ...
    if(!$mensagem->mensagemValida()){
        ...
        //caso haja a tentativa de acessar a 'processa_envio.php' a página é encaminhada para o index.php:
    ...
    try {
        ...
        $mail->Username   = 'webcompleto12@gmail.com';                     // SMTP username
        $mail->Password   = '12378954a';                               // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

        //Recipients
        $mail->setFrom('webcompleto12@gmail.com', 'WebCompleto-remetente');
        ...
        $mail->AltBody = 'É necessário um client que suporta HTML para ter acesso total ao conteúdo dessa mensagem';
            ...
            <div class="row">
                <div class="col-md-12">
                    <? if($mensagem->status['codigo_status'] == 1) { ?>
                        ...
                        <div class="container">
                            <h3 class='display-4 text-sucess'>Sucesso!</h3>
